...
@Slf4j
@Component
public class SessionAssignedEventListener implements ChatEventListener {
    ...
    public boolean supports(ChatEvent event) {
        return ChatEventType.SESSION_ASSIGNED == event.getEventType();
    }
    ...
    public void handleEvent(ChatEvent event) {
        ...
        log.info("Handling session assigned event: {}", event);
