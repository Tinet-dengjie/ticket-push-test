...
@Slf4j
@Component
public class SessionCompletedEventListener implements ChatEventListener {
    ...
    public boolean supports(ChatEvent event) {
        return ChatEventType.SESSION_COMPLETED == event.getEventType();
    }
    ...
    public void handleEvent(ChatEvent event) {
        ...
        log.info("Handling session completed event: {}", event);
