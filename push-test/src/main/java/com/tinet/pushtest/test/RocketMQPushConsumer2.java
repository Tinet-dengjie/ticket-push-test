...
public class RocketMQPushConsumer2 {
    /**
    ...
    public static void main(String[] args) throws MQClientException {
        ...
        consumer.setNamesrvAddr("rmq-cn-vc24046op09.cn-hangzhou.rmq.aliyuncs.com:8080");
        ...
        consumer.registerMessageListener(new MessageListenerConcurrently() {
            ...
            public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs,
                ...
                System.out.println("RocketMQPushConsumer2 接收到数据大小{} " + msgs.size());
                msgs.forEach(item -> {
                    System.out.printf("%s -RocketMQPushConsumer2 Receive New Messages: %s %n",System.currentTimeMillis(), new String(item.getBody(), StandardCharsets.UTF_8));
                });
